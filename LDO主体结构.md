...
本设计中的负载电容容值为**1μF，容值很大**，所以一定是片外电容LDO。片外电容LDO的主极点是输出极点，轻载时稳定性好，重载时稳定性变差。因为重载时负载电流变大，输出电阻变小，主极点就变大，可能将次级点和零点引入带内，稳定性下降。
...
基本结构如上，承担源随器任务的是M1管，而M2管的作用是把M1的输出电阻降低gm2ro1倍。
